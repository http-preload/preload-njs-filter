...
PreloadManifest.prototype.lookup = function (reqPath) {
  return this.map.get(reqPath);
};
PreloadManifest.prototype.supportsEarlyHints = function (userAgentData, headers) {
